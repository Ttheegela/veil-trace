...
# The default assumes this file sits two folders below that root. Sponsor pulls are never in the public repo.
ROOT = Path(os.environ.get("CLIMATE_DAY_ROOT", Path(__file__).resolve().parents[1]))
